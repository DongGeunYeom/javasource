...
<form action="search.jsp" method="post">
	<div class="form-group row">
		<label for="code" class="col-sm-2 col-form-label"><%=dto.getCode()%></label>
		<div class="col-sm-8">
			<input type="text" name="code" id="code" class="form-control" readonly/>
		</div>
	</div>
	<div class="form-group row">
		<label for=title class="col-sm-2 col-form-label"><%=dto.getTitle()%></label>
		<div class="col-sm-8">
			<input type="text" name="title" id="title" class="form-control" readonly/>
		</div>
	</div>
	<div class="form-group row">
		<label for="writer" class="col-sm-2 col-form-label"><%=dto.getWriter()%></label>
		<div class="col-sm-8">
			<input type="text" name="writer" id="writer" class="form-control" readonly/>
		</div>
	</div>
	<div class="form-group row">
		<label for="price" class="col-sm-2 col-form-label"><%=dto.getPrice()%></label>
		<div class="col-sm-8">
